...
import com.example.recruitmentapp.feature.accountDetails.CommitData.Companion.commitDetails
import com.example.recruitmentapp.feature.accountSearch.AccountSearchActivity
import com.example.recruitmentapp.feature.accountSearch.PROFILE_ID
import com.example.recruitmentapp.feature.accountSearch.ProfileData.Companion.profileList
...
class AccountDetailsActivity : BaseActivity(),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        backButton = findViewById(R.id.goBackSet)
        backButton.setOnClickListener { v: View -> displaySearchActivityOnBack(v) }
